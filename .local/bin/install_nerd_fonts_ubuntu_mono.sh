...
curl -L https://github.com/ryanoasis/nerd-fonts/releases/download/v3.3.0/UbuntuMono.zip -o "$dl_dir"/UbuntuMono.zip
unzip -u "$dl_dir"/UbuntuMono.zip -d ~/.local/share/fonts/
curl -L https://github.com/ryanoasis/nerd-fonts/releases/download/v3.3.0/Ubuntu.zip -o "$dl_dir"/Ubuntu.zip
