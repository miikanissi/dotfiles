...
- =jedi:install-server=
* Secrets
In this section I define variables that are loaded from a =.secret.el= file. These secrets contain personal information and machine specific settings that are best to keep away from version control.
          ...
          (list
           (make-mu4e-context
            ...
            :vars `((user-mail-address . ,m/user-mail-address)
                    ...
                    (mu4e-compose-signature . "- Miika Nissi")
