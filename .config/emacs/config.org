...
** Gruvbox
Gruvbox is VERY easy on the eyes and I think that's the most important part of a theme. Gruvbox-theme package also comes with light themes and can easily be switched to using =M-x load-theme=
...
** custom website variables/functions
These variables are used to publish my website.
#+begin_src emacs-lisp
  (defun m:sitemap-format-entry(entry style project)
    ...
    (cond ((not (directory-name-p entry))
          ...
          (t entry)))
  (defcustom website-base-dir "~/miikanissi.com/" "Base directory for website files")
#+end_src
** org-publish
#+begin_src emacs-lisp
  (setq org-publish-project-alist
        '(("static"
           :base-directory "~/miikanissi.com/"
           :base-extension "org"
           :publishing-directory "~/miikanissi.com/public_html/"
           ...
           "<link rel=\"alternate\" type=\"application/rss+xml\"
                  href=\"https://miikanissi.com/posts.xml\"
                  title=\"RSS feed\">"
           :html-preamble
           "<h1>Miika Nissi (https://miikanissi.com/)</h1>
            <hr></hr>
            <div class=\"nav\">
            <ul>
            ...
            <li><a href=\"./blog/blogindex.xml\">RSS</a></li>
            </ul></div>"
           :html-postamble
           "<div class=\"footer\"> Author: <a href=\"https://miikanissi.com\"/>%a</a>.<br>
           Email: %e. <br>
           Last updated %C.<br>
           Built with %c.</div>")
          ("blog"
           :base-directory "~/miikanissi.com/blog/"
           :base-extension "org"
           :publishing-directory "~/miikanissi.com/public_html/blog/"
           :publishing-function org-html-publish-to-html

           :sitemap-title "Blog Index"
           :sitemap-filename "blogindex.org"
           :sitemap-sort-files anti-chronologically
           :sitemap-format-entry m:sitemap-format-entry
           :auto-sitemap t
           :author "Miika Nissi"
           :email "miika@miikanissi.com"
           :with-title t
           ...
           "<h1>Miika Nissi (https://miikanissi.com/)</h1>
            ...
            <li><a href=\"https://github.com/miikanissi\">GitHub</a></li>
            <li><a href=\"./blogindex.xml\">RSS</a></li>
            </ul></div>"
           :html-postamble
           "<div class=\"footer\"> Author: <a href=\"https://miikanissi.com\"/>%a</a>.<br>
           Email: %e. <br>
           ...
           Built with %c.</div>")
          ("images"
           :base-directory "~/miikanissi.com/img/"
           :base-extension "png\\|jpg\\|gif\\|svg"
           :publishing-directory "~/miikanissi.com/public_html/img"
           :publishing-function org-publish-attachment)
          ("css"
           :base-directory "~/miikanissi.com/css/"
           :base-extension "css"
           :publishing-directory "~/miikanissi.com/public_html/css"
           :publishing-function org-publish-attachment)
          ("rss"
           :base-directory "~/miikanissi.com/blog/"
           :base-extension "org"
           :exclude ".*"
           :include ("blogindex.org")
           :publishing-directory "~/miikanissi.com/public_html/blog/"
           ...
           :with-toc nil
           :with-date t)
          ("miikanissi.com" :components ("static" "blog" "images" "css" "rss"))))
#+end_src
