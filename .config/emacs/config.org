...
** custom sitemap-format-entry
This function customizes the sitemap-format-entry to show the publishing date.
#+begin_src emacs-lisp
  ...
  (setq org-publish-project-alist
        '(("static"
           ...
           "<link rel=\"alternate\" type=\"application/rss+xml\"
                  href=\"https://miikanissi.com/blog/blogindex.xml\"
                  title=\"RSS feed\">"
           :html-preamble
           "<header><h1>Miika Nissi (https://miikanissi.com/)</h1>
            <hr></hr>
            <nav><ul>
           ...
           :html-postamble
           "<footer><hr></hr>
           By <a href=\"https://miikanissi.com\"/>%a</a>, %e.<br>
           Last updated %C.<br>
           Built with %c.</footer>")
          ("blog"
           ...
           :sitemap-title "Miika's Blog Index"
